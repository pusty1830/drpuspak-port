        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 mb-4 mb-lg-0 position-relative">
            <div className="position-relative rounded shadow-sm overflow-hidden">
              <a
                href="https://www.youtube.com/watch?time_continue=1&v=3u_Q2r2k2jI&embeds_referring_euri=http%3A%2F%2Fdrpuspaksamal.com%2F&source_ve_path=Mjg2NjY"
                target="_blank"
          ...
          <div className="col-lg-6">
            ...
            >
              <i className="bi bi-heart-fill text-primary me-1"></i>{" "}
              Patient-Centered Approach
            </span>
            <h2 className="fw-bold mb-4 mt-3">Patient-Centered Approach</h2>
            <p className="mb-4 text-white">
              Dr. Samal takes time to understand each patient's unique needs and
              concerns. He believes in educating patients about their conditions
              and involving them in decision-making about their treatment
              options. His approach combines technical expertise with
              compassionate care to achieve the best possible outcomes for every
              patient.
            </p>
